package com.agilie.rxdribbblesdk.services;
...
public interface DribbbleShotsService {
    ...
    @Multipart
    @POST("shots")
    Observable<Void> createShot(@Part("title") String title, @Part MultipartBody.Part image, @Part("description") String description,
    ...
    @Multipart
    @POST("shots")
    Observable<Void> createShot(@Part("title") String title, @Part MultipartBody.Part image);
    ...
    Observable<Void> createShotAttachment(@Path("shot") long shotId, @Part MultipartBody.Part file);
